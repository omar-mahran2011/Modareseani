    ...
    (
      <div
        style={{
          ...
          background: "linear-gradient(135deg, #101B34 0%, #1c2c49 100%)",
          position: "relative",
        }}
      >
        <div
        ...
        >
          <svg width="52" height="52" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 3L2 8l10 5 8-4.2V16h1.5V8L12 3z" fill="#101B34" />
            <path d="M6 11.5V16c0 1.7 2.7 3 6 3s6-1.3 6-3v-4.5l-6 3.15-6-3.15z" fill="#101B34" />
          </svg>
        </div>
